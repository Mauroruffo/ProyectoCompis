...
_lr_productions = [
  ...
  ('program -> PROGRAM ID SEMICOLON vars class bloque','program',6,'p_program','AnalizadorSintactico.py',22),
  ('vars -> VAR varid COLON tipo SEMICOLON','vars',5,'p_vars','AnalizadorSintactico.py',27),
  ('vars -> empty','vars',1,'p_varsEmpty','AnalizadorSintactico.py',32),
  ('varid -> ID','varid',1,'p_varsid1','AnalizadorSintactico.py',36),
  ('varid -> ID COMMA ID','varid',3,'p_varsid2','AnalizadorSintactico.py',39),
  ('varid -> empty','varid',1,'p_varsidEmpty','AnalizadorSintactico.py',42),
  ('tipo -> INT','tipo',1,'p_tipo1','AnalizadorSintactico.py',45),
  ('tipo -> FLOAT','tipo',1,'p_tipo2','AnalizadorSintactico.py',48),
  ('bloque -> LEFT_CURLYB estatutoRecursivo RIGHT_CURLYB','bloque',3,'p_bloque','AnalizadorSintactico.py',51),
  ('estatutoRecursivo -> estatuto estatutoRecursivo','estatutoRecursivo',2,'p_estatutoRec1','AnalizadorSintactico.py',56),
  ('estatutoRecursivo -> empty','estatutoRecursivo',1,'p_estatutoRec2','AnalizadorSintactico.py',59),
  ('estatuto -> asignacion','estatuto',1,'p_estatuto1','AnalizadorSintactico.py',62),
  ('estatuto -> condicion','estatuto',1,'p_estatuto2','AnalizadorSintactico.py',67),
  ('estatuto -> write','estatuto',1,'p_estatuto3','AnalizadorSintactico.py',70),
  ('estatuto -> while','estatuto',1,'p_estatuto4','AnalizadorSintactico.py',73),
  ('estatuto -> read','estatuto',1,'p_estatuto5','AnalizadorSintactico.py',76),
  ('asignacion -> ID EQUAL_ASSIGN expresion SEMICOLON','asignacion',4,'p_asignacion','AnalizadorSintactico.py',79),
  ('condicion -> IF LEFT_PARENTHESIS expresion RIGHT_PARENTHESIS bloque','condicion',5,'p_condicion','AnalizadorSintactico.py',83),
  ('condicion -> condicion ELSE bloque','condicion',3,'p_condicion2','AnalizadorSintactico.py',87),
  ('read -> READ VAR SEMICOLON','read',3,'p_read','AnalizadorSintactico.py',90),
  ('while -> WHILE LEFT_PARENTHESIS expresion RIGHT_PARENTHESIS bloque','while',5,'p_while','AnalizadorSintactico.py',94),
  ('expresion -> exp LESS_THAN exp','expresion',3,'p_expresion1','AnalizadorSintactico.py',98),
  ('expresion -> exp GREATER_THAN exp','expresion',3,'p_expresion2','AnalizadorSintactico.py',102),
  ('expresion -> exp NOT_EQUAL exp','expresion',3,'p_expresion3','AnalizadorSintactico.py',105),
  ('exp -> termino PLUS termino','exp',3,'p_exp1','AnalizadorSintactico.py',108),
  ('exp -> termino MINUS termino','exp',3,'p_exp2','AnalizadorSintactico.py',112),
  ('termino -> factor MULTIPLICATION factor','termino',3,'p_termino1','AnalizadorSintactico.py',115),
  ('termino -> factor DIVISION factor','termino',3,'p_termino2','AnalizadorSintactico.py',119),
  ('factor -> LEFT_PARENTHESIS expresion RIGHT_PARENTHESIS','factor',3,'p_factor1','AnalizadorSintactico.py',122),
  ('factor -> PLUS','factor',1,'p_factor2','AnalizadorSintactico.py',126),
  ('factor -> MINUS','factor',1,'p_factor3','AnalizadorSintactico.py',129),
  ('factor -> varcte','factor',1,'p_factor4','AnalizadorSintactico.py',132),
  ('varcte -> ID','varcte',1,'p_varcte1','AnalizadorSintactico.py',135),
  ('varcte -> CONST_INT','varcte',1,'p_varcte2','AnalizadorSintactico.py',138),
  ('varcte -> CONST_FLOAT','varcte',1,'p_varcte3','AnalizadorSintactico.py',141),
  ('write -> WRITE LEFT_PARENTHESIS inside RIGHT_PARENTHESIS','write',4,'p_write','AnalizadorSintactico.py',144),
  ('inside -> inside more inside','inside',3,'p_writeInside1','AnalizadorSintactico.py',147),
  ('inside -> ID','inside',1,'p_writeInside2','AnalizadorSintactico.py',150),
  ('inside -> string','inside',1,'p_writeInside3','AnalizadorSintactico.py',153),
  ('inside -> empty','inside',1,'p_writeInside4','AnalizadorSintactico.py',156),
  ('more -> MORE','more',1,'p_more1','AnalizadorSintactico.py',159),
  ('more -> empty','more',1,'p_more2','AnalizadorSintactico.py',162),
  ('string -> DOUBLE_QUOTES CONST_STRING DOUBLE_QUOTES','string',3,'p_string','AnalizadorSintactico.py',165),
  ('class -> CLASS LEFT_CURLYB vars method RIGHT_CURLYB','class',5,'p_class','AnalizadorSintactico.py',168),
  ('method -> DEF LEFT_PARENTHESIS varid RIGHT_PARENTHESIS bloquemetodo','method',5,'p_method','AnalizadorSintactico.py',171),
  ('bloquemetodo -> LEFT_CURLYB estatutoRecursivo RIGHT_CURLYB RETURN ID SEMICOLON','bloquemetodo',6,'p_bloquemethod','AnalizadorSintactico.py',174),
  ('empty -> <empty>','empty',0,'p_empty','AnalizadorSintactico.py',177),
]
